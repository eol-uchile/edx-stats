...
class TestTimesOnCourse(UserMixin, JwtMixin, APITestCase):
    ...
    def test_no_ulimit_field_fails(self):
        self.set_jwt_cookie()
        response = self.client.get(self.url+"?search=Test-EOL_T1&llimit=2019-09-04T00:00:00.000000")
        self.assertEqual(response.status_code, 400)
    ...
    def test_course_has_content(self, mock_recoverUserCourseRoles):
        ...
        response = self.client.get(self.url+"?search=Test-EOL_T2&llimit=2019-09-04T00:00:00.000000&ulimit=2019-09-05T00:00:00.000000")
